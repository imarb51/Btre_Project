...
def contact(request):
    if request.method == "POST":
        ...
        if request.user.is_authenticated:
            ...
            if has_contacted:
                messages.error(request, 'You have already made an inquiry from the listing')
        ...
        send_mail(
            'Property Inquiry has been requested',
            'There has been an Inquiry for ' + listing + '.Sign into the admin panel for more info',
            'mr.imranshaikh894@gmail.com',
            [realtor_email,'imranance99@gmail.com'],
            fail_silently=False
        )
